...
export class VkClient {
    ...
    async getComments(group_id, topic_id, count, offset, sort, withProfiles = false) {
        const method = 'board.getComments'

        const resJson = await this.execute(method, {group_id, topic_id, count, offset, sort, extended: +withProfiles })
